...
var globalAnalyticsKey = (standalone_a = document.querySelector('script[data-global-tronic-analytics-key]')) === null || standalone_a === void 0 ? void 0 : standalone_a.dataset.globalTronicAnalyticsKey;
if (globalAnalyticsKey) {
    setGlobalReceiverKey(globalAnalyticsKey);
}
if (shouldPolyfill()) {
